...
<head>
    ...
    <link href="assets/admin/dist/css/custom.css" rel="stylesheet">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide carousel-dark" data-bs-ride="carousel">
                                            <div class="carousel-inner">
                                                <div class="carousel-item active"><img class="d-block img-fluid"
                                                            src="assets/admin/images/big/img1.jpg" alt="First slide">
                                                </div>
                                                <div class="carousel-item"><img class="d-block img-fluid"
                                                            src="assets/admin/images/big/img2.jpg" alt="Second slide">
                                                </div>
                                                <div class="carousel-item"><img class="d-block img-fluid"
                                                            src="assets/admin/images/big/img3.jpg" alt="Third slide">
                                                </div>
                                            </div>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            aria-haspopup="true" aria-expanded="false">
                                ...
                                <img src="{{url('/')}}/{{\App\Models\User::where('id',Session::get('id'))->pluck('image')[0]}}" alt="user" width="30" class="profile-pic rounded-circle" />
                            </a>
                            <div class="dropdown-menu dropdown-menu-end user-dd animated flipInY">
                                <div class="d-flex no-block align-items-center p-3 bg-info text-white mb-2">
                                    <div class=""><img src="{{url('/')}}/{{\App\Models\User::where('id',Session::get('id'))->pluck('image')[0]}}" alt="user" class="rounded-circle" width="60"></div>
                                    <div class="ms-2">
                                ...
                                <div class="dropdown-divider"></div>
                                <div class="pl-4 p-2 d-none"><a href="my_profile.php" class="btn d-block w-100 btn-info rounded-pill">View Profile</a></div>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- Language -->
