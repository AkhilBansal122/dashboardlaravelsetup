...
<!-- Page wrapper  -->
        ...
        <div class="col-md-5 col-12 align-self-center">
            <h4 class="text-themecolor mb-0">Services Details</h4>
		</div>
			...
			<div class="col-12">
				<div class="card">
					<div class="border-bottom title-part-padding">
					    <h4 class="card-title mb-0">Services Details List</h4>             
					</div>
					<div class="card-body">
						...
						<div class="result">
						    ...
						    <div class="col-md-12">
								<a href="{{url('/services_details_add')}}" class="btn btn-success fa-pull-right btn-sm table_add_btn mx-2"  >Add New services_details</a>
							</div>
							<table id="zero_config" class="table table-striped table-bordered">
								...
								<tbody>
                                    @if(!empty($services_details))
                                        @foreach($services_details as $k=> $blog)
                                            <tr>
                                                <td>{{$k+1}}</td>
                                                <td>
											...
											<td>
												...
												<a href="javascript:void(0);" class="btn btn-info btn-sm list_edit edit_services_details" 
                                                data-id = "{{$blog->id}}" data-name = "{{$blog->name}}" data-description = "{{$blog->description}}"
                                                >
													<i class="mdi mdi-lead-pencil"></i>
												</a> 
											    <a href="{{ route('services_details_delete', $blog->id) }}" onclick="return confirm('Are you sure delete this services_details？')" class="btn btn-danger btn-sm list_delete">
...
<div class="modal fade" id="edit_services_details_modal" tabindex="-1" >
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header d-flex align-items-center">
				<h4 class="modal-title" id="exampleModalLabel1">Edit services_details</h4>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
            <form id="editservices_detailsform" action="javascript:void(0)">
           <div class="modal-body">
			        <input type="hidden" id ="services_detailsid" name="id"/>
					<input type="hidden" value="services_details_edit" name="type"/>
					<div class="mb-3">
						<label for="recipient-name" class="control-label"> Name: <span style="color:Red">*</span></label>
						<input type="text" class="form-control" name="name" id="editservices_detailsname" required value="">
					</div>
					<div class="mb-3">
						<label for="recipient-name" class="control-label">services_details Description: <span style="color:Red">*</span></label>
						<textarea class="form-control" name="description" id="services_detailsdescription" required value=""></textarea>
					</div>
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-success btn_submit">Edit services_details</button>
			</div>
            </form>
		</div>
	</div>
