...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h4 class="text-themecolor mb-0">Add New Services Detals</h4>
		</div>
        <div class="col-md-7 col-12 align-self-center d-none d-md-block">
            <ol class="breadcrumb mb-0 p-0 bg-transparent fa-pull-right">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Add New Services Detals</li>
			</ol>
		</div>
	</div>
    <!-- ============================================================== -->
			...
			<div class="col-12">
				<div class="card">
					<div class="border-bottom title-part-padding">
					    <h4 class="card-title mb-0">Add Services Detals</h4>             
					</div>
					<div class="card-body min_height">
					    <form class="row" id="Services_Detals_add_form" enctype="multipart/form-data"  action="javascript:void(0)" method="post">
							<div class="col-md-12 result">
							</div>

							<input type="hidden" name="type" value="service_details_add" id="type"/>
							<div class="mb-3 col-md-6">
								<label for="recipient-name"  class="control-label">Select Services:<span style="color:red">*</span></label>
								<select class="form-control" required id="name" name="services_id">
