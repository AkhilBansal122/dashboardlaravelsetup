                            ...
                            <div class="card-body">
                                <center class="mt-4"> 
								    <div class="profile_img">
                                        @if(Session::has('id'))
                                        <img src="{{url('/')}}/{{\App\Models\User::where('id',Session::get('id'))->pluck('image')[0]}}" class="rounded-circle" />
@else
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="col-md-12">
                                                   <input type="hidden" name="id" value="{{Session::get('id')}}">
                                                      <input type="hidden" name="name" value="{{\App\Models\User::where('id',Session::get('id'))->pluck('name')[0]}}">
